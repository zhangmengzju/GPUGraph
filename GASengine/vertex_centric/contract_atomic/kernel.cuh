  ...
  namespace vertex_centric
  {
    namespace contract_atomic
    {
      ...
      struct SweepPass<KernelPolicy, Program, true >
      {
        ...
        static __device__ __forceinline__ void Invoke(typename Program::VertexId &iteration, typename Program::VertexId &queue_index,
                                                      typename Program::VertexId &steal_index,
                                                      int &num_gpus, typename KernelPolicy::VertexId *&d_edge_frontier, typename Program::VertexId *&d_vertex_frontier,
                                                      typename Program::MiscType *&d_predecessor,
                                                      typename Program::VertexId *&d_labels, typename Program::MiscType *&d_preds, typename KernelPolicy::EValue *&d_sigmas,
                                                      typename Program::VisitedMask *&d_visited_mask,
