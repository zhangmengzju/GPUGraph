    ...
    namespace contract_atomic
    {
      ...
      struct SweepPass
      {
            ...
            typename KernelPolicy::SmemStorage &smem_storage)
        {
          ...
          Cta cta(iteration, queue_index, num_gpus, selector, d_frontier_size, smem_storage, d_edge_frontier, d_vertex_frontier, d_predecessor, m_gatherTmp, vertex_list, edge_list, d_visited_mask, work_progress,
              max_vertex_frontier);
...
//              work_progress.template PrepResetSteal<SizeT>(steal_index + 1);
          ...
          SweepPass<KernelPolicy, Program, KernelPolicy::WORK_STEALING>::Invoke(iteration, queue_index, steal_index, num_gpus, selector, d_frontier_size, d_edge_frontier, d_vertex_frontier,
              d_predecessor, m_gatherTmp, vertex_list, edge_list, d_visited_mask, work_progress, smem_storage.state.work_decomposition, max_vertex_frontier, smem_storage);
